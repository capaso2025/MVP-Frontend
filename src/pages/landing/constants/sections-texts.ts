export const SECTIONS_TEXTS = {
  NOSOTROS: {
    ...
    DESCRIPTION:
      'Cada herramienta y contenido ha sido desarrollado con el acompañamiento de psicólogos especializados en adolescentes y jóvenes. Tu bienestar emocional es tan importante como tu crecimiento académico y personal.',
    ID: 'nosotros',
  },
  NOSOTROS_2: {
