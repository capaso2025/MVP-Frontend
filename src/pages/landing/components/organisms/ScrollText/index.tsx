    ...
    <>
      ...
      >
        <div className="flex h-full w-full items-center justify-center">
          <Typography className="px-[5%] !text-2xl font-bold text-white md:!text-[50px] lg:!text-[70px]">
      ...
      >
        ...
        <div className="bg-primary-dark grid h-[100vh] place-content-center">
          <Typography className="px-[5%] text-center text-xl font-bold text-white md:text-2xl!">
