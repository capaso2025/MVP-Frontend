...
export default function TeacherSignupForm() {
  ...
  return (
    <div className="animate-fade-in mx-auto mt-4 max-w-xl rounded-lg bg-white px-8 py-4">
      ...
      <form className="space-y-4">
        ...
        <div className="relative">
          ...
          <select
            className="w-full appearance-none rounded-lg border border-gray-300 px-4 py-3"
          ...
          <ChevronDownIcon className="pointer-events-none absolute top-10 right-3 h-5 w-5 text-gray-500" />
        </div>
        ...
        <div className="relative">
          <select className="w-full appearance-none rounded-lg border border-gray-300 px-4 py-3">
          ...
          <ChevronDownIcon className="pointer-events-none absolute top-3.5 right-3 h-5 w-5 text-gray-500" />
        </div>
        ...
        <Button size="lg" className="w-full" onClick={handleInscription}>
          Inscríbete
        </Button>
      </form>
    </div>
