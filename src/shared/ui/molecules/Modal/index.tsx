...
function Modal() {
  ...
  return ReactDOM.createPortal(
    ...
    >
      <div
        className={`relative overflow-auto shadow-xl max-h-[95vh] p-4 ${fullScreen ? 'h-full w-full' : 'mx-auto min-h-[200px] w-[90%] max-w-[500px] rounded-2xl  p-4 md:min-w-[400px]'} ${containerClassName || 'bg-landing-dark'
          }`}
      >
        {noCloseButton ? null : (
          <div
